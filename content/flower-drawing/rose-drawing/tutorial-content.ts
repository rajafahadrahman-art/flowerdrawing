...
export const roseInfo = {
  ...
  mainSubject: "Rose with a stem and leaves",
  bestFor: "Beginners",
} as const;

export const roseMaterialsNote =
  "You can complete this tutorial with a few basic drawing tools:";

export const roseMaterialsExtra =
...
export const roseSteps: RoseStep[] = [
  ...
  {
    title: "Step 2: Add the First Folded Petals",
    paragraphs: [
  ...
  {
    title: "Step 3: Build the Middle Petals",
    paragraphs: [
  ...
  {
    title: "Step 4: Add the Outer Petals",
    paragraphs: [
  ...
  {
    title: "Step 5: Refine the Petal Edges",
    paragraphs: [
  ...
  {
    title: "Step 6: Draw the Stem and Sepals",
    paragraphs: [
  ...
  {
    title: "Step 8: Clean the Final Outline",
    paragraphs: [
  ...
  {
    title: "Step 9: Add Light Shading",
    paragraphs: [
...
export const roseOutlineSection = {
  ...
  versions: [
    {
      title: "Basic Outline",
      text: "Use smooth lines and fewer petals. This is suitable for beginners, kids, tracing activities, and printable worksheets.",
    },
    {
      title: "Detailed Outline",
      text: "Include more overlapping petals, folded edges, leaf veins, and small contour lines. This version is better for intermediate artists or anyone who wants a more decorative result.",
    },
  ],
  closing:
...
export const roseRealisticSection = {
  intro: [
  ...
  areas: [
    {
      title: "Petal Direction",
      text: "Observe how petals grow outward from the center. Inner petals usually stand more upright, while outer petals spread and curve away from the bloom.",
    },
    {
      title: "Overlapping Forms",
      text: "Show clearly which petal sits in front and which one falls behind. Darkening the contact areas between petals creates separation.",
    },
    {
      title: "Folded Edges",
      text: "Some petals curl inward while others bend outward. A short contour line near an edge can suggest a fold without covering the petal in unnecessary detail.",
    },
    {
      title: "Light and Shadow",
      text: "Keep the light-facing areas soft and add stronger shadows in narrow spaces. The darkest values are often found near the center and beneath overlapping forms.",
    },
    {
      title: "Uneven Shapes",
      text: "Real petals are not identical. Vary their widths, lengths, angles, and outer edges.",
    },
  ],
  closing:
...
export const roseColorSections = [
  {
    title: "Red Rose Drawing with Colored Pencils",
    paragraphs: [
  ...
  {
    title: "Small Rose Drawing Practice",
    paragraphs: [
  ...
  {
    title: "Cute Rose Drawing Easy Idea",
    paragraphs: [
  ...
  {
    title: "Rose Bouquet Drawing Basics",
    paragraphs: [
...
export const roseMistakes = [
  {
    title: "Making Every Petal the Same",
    text: "Identical petals make the flower look flat. Change their size, angle, and curve as you move outward.",
  },
  {
    title: "Starting with Dark Lines",
    text: "Heavy construction lines are difficult to erase. Use gentle pressure until the structure is complete.",
  },
  {
    title: "Making the Center Too Large",
    text: "A large spiral leaves little room for the surrounding petals. Keep the first shape compact.",
  },
  {
    title: "Adding Too Many Random Lines",
    text: "Extra lines can make the flower confusing. Every contour should describe a fold, edge, or overlap.",
  },
  {
    title: "Forgetting the Base of the Flower",
    text: "Sepals help connect the bloom to the stem and make the drawing of rose structure feel complete.",
  },
  {
    title: "Shading Every Area Equally",
    text: "Uniform shading removes depth. Keep highlights light and place darker values only in selected areas.",
  },
] as const;

export const roseWorksheetIntro = [
  "The printable worksheet allows you to study the complete picture and practice the same process independently.",
] as const;

export const roseWorksheetIncludes = [
...
export const roseWorksheetClosing = [
