...
export const meta: TutorialMeta = {
  title: "Easy Tulip Drawing Step-by-Step Tutorial for Beginners",
  slug: "tulip-drawing",
  focusKeyword: "Tulip Drawing",
  seoTitle: "Tulip Drawing Easy Step-by-Step Tutorial for Beginners",
  metaDescription:
    "Learn how to draw a tulip with easy visual steps, simple outline guidance, realistic pencil tips, coloring ideas and a printable worksheet.",
  excerpt:
  ...
  mainSubject: "Tulip with a stem and two leaves",
  bestFor: "Beginners",
  materials: [
  ...
  faqs: [
    ...
    {
      question: "Can children follow a step by step tulip drawing?",
      answer:
        "Yes. A step by step drawing can be simplified into a U-shaped bloom, three top points, one stem, and two leaves.",
    },
    {
      question: "How can I turn the sketch into a cartoon tulip drawing?",
      answer:
